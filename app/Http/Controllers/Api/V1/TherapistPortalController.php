        ...
        try {
            ...
            $html = MailHelper::template("
                ...
                <p style='color:#374151;'>
                    A new <strong>leave request</strong> has been submitted by
                    <strong>{$therapistName}</strong> and is waiting for your approval.
                </p>
                <table style='width:100%;border-collapse:collapse;margin:20px 0;'>
                    <tr style='background:#f5f3ff;'>
                        <td style='padding:10px 14px;font-weight:600;color:#7c3aed;width:130px;'>Therapist</td>
            ...
            try {
                ...
                Log::error('Therapist leave email failed', ['error' => $mailEx->getMessage()]);
            }
            // ────────────────────────────────────────────────────────────
